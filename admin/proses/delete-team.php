...
include "../../config.php";
$gambar = $_GET["gambar"];
$i = mysqli_query($conn, "SELECT * FROM team WHERE gambar ='$gambar' ");
$u = mysqli_fetch_array($i);
//Menghapus file yang ada pada folder team
if (is_file("../../assets/team/" . $u['gambar'])) unlink("../../assets/team/" . $u['gambar']);
$sql = "DELETE FROM team WHERE gambar='$gambar' ";
